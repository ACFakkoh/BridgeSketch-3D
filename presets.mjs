...
export const presets = [
  {
    ...
    config:{...defaults,material:'steel',steelColor:'green',width:13.2,girders:5,overhang:1.3,
      ...
      barrierType:'steel',sidewalkSide:'right',sidewalkWidth:2,abutmentType:'return',wingAngle:35,
      elevation:6.8,rise:.45,approach:24,pierType:'bent',columns:2,columnDiameter:1.1,
      bentWidth:1.8,bentThickness:.9,environment:'rural',seed:24,laneWidth:3.5,movingTraffic:true,
  ...
  },
  {
    ...
    config:{...defaults,material:'concrete',width:11.4,girders:4,overhang:1.2,depth:1.4,
      elevation:6.1,rise:.3,approach:22,barrierType:'steel',abutmentType:'return',wingAngle:45,
  ...
  },
  {
    ...
    config:{...defaults,material:'box',steelColor:'blue',girders:2,boxTopWidth:5.1,boxBottomWidth:4.45,overhang:3.75,
      ...
      barrierType:'steel',sidewalkSide:'right',sidewalkWidth:2.5,pierType:'hammerhead',
  ...
  },
  {
    ...
    config:{...defaults,material:'slab',width:10.6,slabDepth:.5,continuous:true,variableDepth:true,
      ...
      barrierType:'steel',sidewalkSide:'right',sidewalkWidth:1.8,abutmentType:'return',wingAngle:40,
  ...
  },
  {
    ...
    config:{...defaults,material:'concrete',width:23.6,girders:7,overhang:1.5,depth:1.6,
      ...
      bentWidth:2.2,bentThickness:1.1,skew:8,elevation:7.4,profile:'constant',grade:.5,
  ...
  },
  {
    ...
    config:{...defaults,material:'steel',steelColor:'weathered',width:11.4,girders:4,
      ...
      barrierType:'steel',abutmentType:'return',wingAngle:35,environment:'rural',seed:56,
