...
- **Structure:** metric NEBT concrete girders, steel plate girders, 1–14 hollow steel boxes with two 500 × 50 mm top flanges and inclined webs, or a solid concrete slab. Variable-depth steel girders and slabs can deepen at piers or, on a single span, at the abutments. A 400 mm constant-depth zone remains over the bearings. Painted steel includes the requested AMS-STD-595 brown, green, gray, three blues and red, plus weathered steel and custom hex input.
